...
This was a fun, easy front-end project. Our workflow is clearly improving. A few minor formatting issues came up, such as with the tables, but were easily addressed in CSS.